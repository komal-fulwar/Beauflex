<?php if ( ! defined( 'ABSPATH' ) ) { exit; }
	...
	$img_size = array( 'one-column' => 'full', 'one-half-column' => 'iva-blog-ii-column', 'one-third-column' => 'iva-blog-iii-column', 'one-fourth-column' => 'iva-blog-iv-column' );
	...
	elseif( has_post_thumbnail( $post_ID ) ) : ?>
		<a href="<?php echo get_permalink($post_ID);?>" title="<?php printf(esc_attr__('Permalink to %s','iva'), the_title_attribute('echo=0'));?>">

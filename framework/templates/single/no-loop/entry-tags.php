<?php if ( ! defined( 'ABSPATH' ) ) { exit; }
	...
	if( $post_Style == 'breadcrumb-fixed' ):
		echo get_the_tag_list( '<div class="tag-wrap"><span>'.esc_html__('A story about', 'iva').'</span><p>', ' ', '</p></div>', $post_ID );
	elseif( $post_Style == 'overlay' ):
		echo get_the_tag_list( '<span>'.esc_html__('Tags : ', 'iva').'</span>', ', ', '', $post_ID );

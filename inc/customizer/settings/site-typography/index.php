...
$wp_customize->add_panel( 
	new IVA_WP_Customize_Panel(
		...
		array(
			'title'    => esc_html__('Site Typography', 'iva'),
			'priority' => 50
		)
	)
);
	...
	$wp_customize->add_section( 
		new IVA_WP_Customize_Section(
			...
			'site-body-section',
			array(
				'title'    => esc_html__('Body & Content', 'iva'),
	...
	$wp_customize->add_section( 
		new IVA_WP_Customize_Section(
			...
			array(
				'title'    => esc_html__('Custom Fonts', 'iva'),
				'panel'    => 'site-typograpy-main-panel',
				'priority' => 45
			)
		)

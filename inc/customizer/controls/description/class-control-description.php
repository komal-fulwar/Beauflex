<?php
/**
 * THEMENAME Theme Customizer Control: description
 *
 */
...
class IVA_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'iva-description-control',  IVA_THEME_URI . '/inc/customizer/controls/description/description.css', null, IVA_THEME_VERSION );
	}	

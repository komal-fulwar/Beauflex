<?php
/**
 * THEMENAME Theme Customizer Control: radio-image
 *
 */
...
class IVA_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'iva-radio-image-control', IVA_THEME_URI . '/inc/customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), IVA_THEME_VERSION, true );
		wp_enqueue_style( 'iva-radio-image-control',  IVA_THEME_URI . '/inc/customizer/controls/radio-image/radio-image.css', null, IVA_THEME_VERSION );
	}

<?php
/**
 * THEMENAME Theme Customizer Control: Upload
 *
 */
...
class IVA_Customize_Control_Upload extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'iva-upload-control',  IVA_THEME_URI . '/inc/customizer/controls/upload/upload.css', null, IVA_THEME_VERSION );
		wp_enqueue_script( 'iva-upload-control', IVA_THEME_URI . '/inc/customizer/controls/upload/upload.js', array( 'jquery', 'customize-base' ), IVA_THEME_VERSION, true );
	}
                ...
                <div class="upload-file">
                    <div class="attachment-file-view upload-file">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="button upload-file-button"><?php esc_attr_e( 'Select File', 'iva' ); ?></button>
                        </div>
                    </div>
                </div>
			</div>

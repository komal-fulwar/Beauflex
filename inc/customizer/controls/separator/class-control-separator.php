<?php
/**
 * THEMENAME Theme Customizer Control: separator
 *
 */
...
class IVA_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'iva-separator-control',  IVA_THEME_URI . '/inc/customizer/controls/separator/separator.css', null, IVA_THEME_VERSION );
	}	

<?php
/**
 * THEMENAME Theme Customizer Control: Responsive Spacing Field
 *
 */
...
class IVA_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'iva-responsive-spacing-control', IVA_THEME_URI . '/inc/customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), IVA_THEME_VERSION, true );
		wp_enqueue_style( 'iva-responsive-spacing-control',  IVA_THEME_URI . '/inc/customizer/controls/responsive-spacing/responsive-spacing.css', null, IVA_THEME_VERSION );
	}

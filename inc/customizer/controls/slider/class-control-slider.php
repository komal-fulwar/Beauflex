<?php
/**
 * THEMENAME Theme Customizer Control: slider
 *
 */
...
class IVA_Customize_Control_Slider extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'iva-slider-control', IVA_THEME_URI . '/inc/customizer/controls/slider/slider.js', array( 'jquery', 'customize-base' ), IVA_THEME_VERSION, true );
		wp_enqueue_style( 'iva-slider-control',  IVA_THEME_URI . '/inc/customizer/controls/slider/slider.css', null, IVA_THEME_VERSION );
	}

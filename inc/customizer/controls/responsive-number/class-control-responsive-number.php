<?php
/**
 * THEMENAME Theme Customizer Control: Responsive Number Field
 *
 */
...
class IVA_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'iva-responsive-number-control', IVA_THEME_URI . '/inc/customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), IVA_THEME_VERSION, true );
		wp_enqueue_style( 'iva-responsive-number-control',  IVA_THEME_URI . '/inc/customizer/controls/responsive-number/responsive-number.css', null, IVA_THEME_VERSION );
	}

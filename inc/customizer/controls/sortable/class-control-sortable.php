<?php
/**
 * THEMENAME Theme Customizer Control: sortable
 *
 */
...
class IVA_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'iva-sortable-control', IVA_THEME_URI . '/inc/customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), IVA_THEME_VERSION, true );
		wp_enqueue_style( 'iva-sortable-control',  IVA_THEME_URI . '/inc/customizer/controls/sortable/sortable.css', null, IVA_THEME_VERSION );
	}

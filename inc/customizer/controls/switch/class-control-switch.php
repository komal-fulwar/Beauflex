<?php
/**
 * THEMENAME Theme Customizer Control: Switch Field
 *
 */
...
class IVA_Customize_Control_Switch extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'iva-switch-control',  IVA_THEME_URI . '/inc/customizer/controls/switch/switch.css', null, IVA_THEME_VERSION );
		wp_enqueue_script( 'iva-switch-control', IVA_THEME_URI . '/inc/customizer/controls/switch/switch.js', array( 'jquery', 'customize-base' ), IVA_THEME_VERSION, true );		
	}
			...
			<div class="customize-control-content switch">
				...
				<label class="switch-label" for="switch_{{ data.id }}">
					<span class="switch-on">
						<# data.choices.on = data.choices.on || '<?php esc_html_e( 'On', 'iva' ); ?>' #>
						{{ data.choices.on }}
					</span>
					<span class="switch-off">
						<# data.choices.off = data.choices.off || '<?php esc_html_e( 'Off', 'iva' ); ?>' #>
						{{ data.choices.off }}
					</span>
				</label>
			</div>
